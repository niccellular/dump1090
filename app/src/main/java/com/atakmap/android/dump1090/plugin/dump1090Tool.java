...
import com.atakmap.android.dump1090.dump1090DropDownReceiver;
...
public class dump1090Tool extends Tool implements ToolDescriptor {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                dump1090DropDownReceiver.SHOW_PLUGIN);
